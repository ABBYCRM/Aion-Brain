...
class AionSettings {
  constructor() {
    ...
    this.primaryModel = fromEnv('PRIMARY_MODEL', 'meta/llama-3.1-8b-instruct');
    this.fallbackModels = csv(fromEnv('FALLBACK_MODELS', 'nvidia/nemotron-3-nano-30b-a3b,grok-4-fast-reasoning,gpt-4.1-mini,claude-3-5-haiku-latest'));
