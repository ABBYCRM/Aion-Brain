...
class AionSettings {
  constructor() {
    ...
    //
    // v0.1.16 — agentic NIM defaults. VIDEO-Engine-CCFL confirmed
    // nvidia/nemotron-3-super-120b-a12b (tool-capable, 384–606ms) on the
    // same integrate.api.nvidia.com catalog. Ultra 550B is the stronger
    // agent model when the key can reach it; Kimi K2.6 is the native
    // tool-calling fallback. Retired Llama 3.1/3.3 IDs stay out of the
    // default chain (HTTP 410).
    ...
    this.fallbackModels = csv(fromEnv('FALLBACK_MODELS', 'moonshotai/kimi-k2.6,nvidia/nemotron-3-super-120b-a12b,nvidia/nemotron-3-nano-30b-a3b,grok-4-fast-reasoning,gpt-4.1-mini'));
